...
async function getAvailableSlots(
  ...
  // Get "today" in the business owner's timezone
  ...
  const todayStr = fmtDate(nowInTz);
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (
      ...
      availableSlots = await getAvailableSlots(supabase, profile.id, profile.timezone || "Australia/Adelaide");
    }
